...
/* Servicios como fichas redondeadas (ref. BTO Digital). Cada card
   enlaza a contacto: el CTA real es arrancar la conversación. */
const CARDS = [
  ...
  return (
    <section id="servicios" className="py-20 sm:py-28 lg:py-32">
      <div className="mx-auto max-w-[1240px] px-5 sm:px-8 lg:px-14">
        ...
        <div ref={grid} className="rv grid gap-4 sm:grid-cols-2 lg:grid-cols-4 sm:gap-5">
          {CARDS.map((c) => (
            <a
              key={c.n}
              href="#contacto"
            ...
            >
              ...
              <span className="mt-6 inline-flex items-center gap-1.5 font-mono text-[10.5px] uppercase tracking-[0.16em] text-primary">
                {t("card.more")}
                <span
                  aria-hidden="true"
