    ...
    <section className="pt-14 sm:pt-20 lg:pt-24">
      <div className="mx-auto max-w-[1240px] px-5 sm:px-8 lg:px-14">
        <p ref={kicker} className="rv font-mono text-[11px] uppercase tracking-[0.24em] text-muted-foreground">
          <b className="font-normal text-primary">Manuel Candoli</b>
          {t("hero.kicker")}
          {year}
        </p>
        <h1
          ref={title}
          className="rv mt-4 font-serif text-[clamp(52px,10.5vw,152px)] font-normal leading-[0.92] tracking-[-0.025em]"
        >
          {t("hero.h1a")}
          <span className="block pl-[clamp(0px,8vw,150px)] italic">
            {t("hero.h1b")} <b className="font-normal text-primary">{t("hero.h1c")}</b>
          </span>
        </h1>
        ...
        <p ref={lede} className="rv mt-5 max-w-[52ch] text-[clamp(17px,2vw,21px)] leading-relaxed text-muted-foreground">
          {t("hero.lede")}
        </p>
